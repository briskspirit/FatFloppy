...
def prepared_controller(
    ...
    This fixture writes a populated 360K disk image to Drive B, initializes
...
class TestHardwareDriveBRead:
    ...
    def test_06_hw_b_read_subdir_file(
    ...
    def test_07_hw_b_get_disk_info(self, prepared_controller: DiskController) -> None:
        ...
        assert len(clusters) == 6, (
            f"Expected 6 allocated clusters for populated 360k disk, "
