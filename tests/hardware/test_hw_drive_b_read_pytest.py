...
"""
Hardware tests for read operations on Drive B using a 360K formatted disk.
...
The tests will:
1.  Use Greaseweazle to write a pre-populated 360K disk image.
...
from .conftest import GW_FORMAT_360K, POPULATED_360K_IMG, _run_gw_write
...
def prepared_controller(
    ...
    1.  Writes a populated 360K disk image to the floppy in Drive B
...
class TestHardwareDriveBRead:
    """
    A collection of read-only tests for a 360K floppy in Drive B.

    These tests assume the drive has been prepared by the `prepared_controller`
    fixture with a standard, populated filesystem.
    """

    def test_01_hw_B_list_root(self, prepared_controller: DiskController) -> None:
    ...
    def test_02_hw_B_list_dir1(self, prepared_controller: DiskController) -> None:
    ...
    def test_03_hw_B_list_subdir(self, prepared_controller: DiskController) -> None:
    ...
    def test_04_hw_B_read_root_file(self, prepared_controller: DiskController) -> None:
    ...
    def test_05_hw_B_read_dir1_files(self, prepared_controller: DiskController) -> None:
    ...
    def test_06_hw_B_read_subdir_file(self, prepared_controller: DiskController) -> None:
    ...
    def test_07_hw_B_get_disk_info(self, prepared_controller: DiskController) -> None:
