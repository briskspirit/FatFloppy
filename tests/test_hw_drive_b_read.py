...
FMT_PROFILE = FLOPPY_FORMATS['ibm_5.25_360k'] # Expected format
...
class TestHardwareDriveBRead(unittest.TestCase):
    ...
    def test_01_hw_B_list_root(self):
    ...
    def test_02_hw_B_list_dir1(self):
    ...
    def test_03_hw_B_list_subdir(self):
    ...
    def test_04_hw_B_read_root_file(self):
    ...
    def test_05_hw_B_read_dir1_files(self):
    ...
    def test_06_hw_B_read_subdir_file(self):
    ...
    def test_07_hw_B_get_disk_info(self):
        ...
        self.assertEqual(len(clusters), 6, "Expected more allocated clusters for populated 360k disk")
