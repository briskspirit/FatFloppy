...
class DiskIODriver(ABC):
    ...
    def __init__(self):
        ...
        Raises:
            ValueError: If driver_type or driver_category is not defined.
        """
    ...
    def get_format_requirements(self) -> dict:
        ...
        Returns:
            A dictionary describing format requirements with keys:
            - needs_format_for_open: Requires format info to open
            - needs_format_for_io: Requires format info for read/write
            - can_derive_format: Can detect format from file
            - preferred_detection_method: 'embedded', 'auto', or 'explicit'
        """
        return {
