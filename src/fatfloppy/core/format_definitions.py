...
FLOPPY_FORMATS: Dict[str, FormatProfile] = {
    ...
    "hdos_5.25_100k": FormatProfile(
        ...
        filesystem_config=HDOSLabelRecord(
            ...
            volume_number=1,
            cluster_factor=2,
            dir_start_block=130, # Representative value for HDOS 2.0+, for HDOS 1.x this would be 222
            grt_start_block=148  # Representative value for HDOS 2.0+, for HDOS 1.x this would be 238
        ),
    ),
    ...
    "hdos_5.25_200k_dssd": FormatProfile(
        ...
        physical_format=PhysicalFormat(
            ...
            bytes_per_sector=256,
            track_formats=[
                TrackFormat(0, 39, 0, 1, 10, "FM", 250, 1, id_start=1, gap1_bytes=45, gap2_bytes=12, gap3_bytes=30)
            ],
        ),
        filesystem_type="HDOS",
        filesystem_config=HDOSLabelRecord(
