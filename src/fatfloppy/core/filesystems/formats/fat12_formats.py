...
MEDIA_DESCRIPTOR_DD_525_360K = 0xFD
MEDIA_DESCRIPTOR_DD_525_180K = 0xFC
MEDIA_DESCRIPTOR_DD_525_160K = 0xFE
MEDIA_DESCRIPTOR_DD_525_320K = 0xFF
MEDIA_DESCRIPTOR_HD_525 = 0xF9
MEDIA_DESCRIPTOR_8INCH_SD_SS = 0xFE
MEDIA_DESCRIPTOR_8INCH_SD_DS = 0xFD
MEDIA_DESCRIPTOR_8INCH_DD = 0xFE
MEDIA_DESCRIPTOR_8INCH_DD_630K = 0x00

BYTES_PER_SECTOR_128 = 128
BYTES_PER_SECTOR_256 = 256
BYTES_PER_SECTOR_512 = 512
BYTES_PER_SECTOR_1024 = 1024

CYLINDERS_35_STANDARD = 80
CYLINDERS_35_EXTENDED = 82
CYLINDERS_525_DD = 40
CYLINDERS_525_HD = 80
CYLINDERS_8INCH = 77
...
FAT12_FORMATS["ibm_3.5_1.44m"] = FormatProfile(
    ...
    filesystem_config=FATVolumeInfo(
        ...
        num_heads=2,
        total_sectors=2880,
        media_descriptor=MEDIA_DESCRIPTOR_HD_35,
        root_entries=224,
        sectors_per_fat=9,
...
FAT12_FORMATS["ibm_3.5_720k"] = FormatProfile(
    ...
    filesystem_config=FATVolumeInfo(
        ...
        num_heads=2,
        total_sectors=1440,
        media_descriptor=MEDIA_DESCRIPTOR_DD_35,
        root_entries=112,
        sectors_per_fat=3,
...
FAT12_FORMATS["ibm_3.5_320k"] = FormatProfile(
    ...
    filesystem_config=FATVolumeInfo(
        ...
        num_heads=1,
        total_sectors=640,
        media_descriptor=MEDIA_DESCRIPTOR_DD_525_320K,
        root_entries=112,
        sectors_per_fat=1,
        sectors_per_cluster=2,
    ),
...
FAT12_FORMATS["ibm_3.5_360k"] = FormatProfile(
    ...
    filesystem_config=FATVolumeInfo(
        ...
        num_heads=1,
        total_sectors=720,
        media_descriptor=MEDIA_DESCRIPTOR_DD_525_180K,
        root_entries=112,
        sectors_per_fat=2,
        sectors_per_cluster=2,
    ),
...
pf_35_168.track_formats = [replace(pf_35_168.track_formats[0], interleave=INTERLEAVE_2)]
...
pf_35_172 = create_35_dshd_base(sectors_per_track=21, cylinders=CYLINDERS_35_EXTENDED)
pf_35_172.track_formats = [replace(pf_35_172.track_formats[0], interleave=INTERLEAVE_2)]
...
FAT12_FORMATS["ibm_5.25_160k"] = FormatProfile(
    ...
    filesystem_config=FATVolumeInfo(
        ...
        num_heads=1,
        total_sectors=320,
        media_descriptor=MEDIA_DESCRIPTOR_DD_525_160K,
        root_entries=64,
        sectors_per_fat=1,
        sectors_per_cluster=1,
    ),
...
FAT12_FORMATS["ibm_5.25_360k"] = FormatProfile(
    ...
    filesystem_config=FATVolumeInfo(
        ...
        num_heads=2,
        total_sectors=720,
        media_descriptor=MEDIA_DESCRIPTOR_DD_525_360K,
        root_entries=112,
        sectors_per_fat=2,
        sectors_per_cluster=2,
    ),
...
FAT12_FORMATS["ibm_5.25_1.2m"] = FormatProfile(
    ...
    filesystem_config=FATVolumeInfo(
        ...
        num_heads=2,
        total_sectors=2400,
        media_descriptor=MEDIA_DESCRIPTOR_HD_525,
        root_entries=224,
        sectors_per_fat=7,
        sectors_per_cluster=1,
    ),
...
FAT12_FORMATS["ibm_8_250k"] = FormatProfile(
    ...
    filesystem_config=FATVolumeInfo(
        ...
        bytes_per_sector=BYTES_PER_SECTOR_128,
        num_heads=1,
        total_sectors=2002,
        media_descriptor=MEDIA_DESCRIPTOR_8INCH_SD_SS,
        root_entries=68,
        sectors_per_fat=6,
...
FAT12_FORMATS["ibm_8_298k"] = FormatProfile(
    ...
    filesystem_config=FATVolumeInfo(
        sectors_per_track=15,
        bytes_per_sector=BYTES_PER_SECTOR_256,
        num_heads=1,
        total_sectors=1155,
        media_descriptor=MEDIA_DESCRIPTOR_8INCH_SD_SS,
        root_entries=56,
...
FAT12_FORMATS["ibm_8_500k"] = FormatProfile(
    ...
    filesystem_config=FATVolumeInfo(
        ...
        total_sectors=4004,
        reserved_sectors=2,
        media_descriptor=MEDIA_DESCRIPTOR_8INCH_SD_DS,
        root_entries=96,
        sectors_per_fat=12,
        sectors_per_cluster=4,
    ),
...
FAT12_FORMATS["ibm_8_630k"] = FormatProfile(
    ...
    filesystem_config=FATVolumeInfo(
        sectors_per_track=8,
        bytes_per_sector=BYTES_PER_SECTOR_1024,
        num_heads=1,
        total_sectors=616,
        media_descriptor=MEDIA_DESCRIPTOR_8INCH_DD_630K,
        root_entries=96,
        sectors_per_fat=1,
        sectors_per_cluster=1,
    ),
...
FAT12_FORMATS["ibm_8_1025k"] = FormatProfile(
    ...
    filesystem_config=FATVolumeInfo(
        ...
        num_heads=2,
        total_sectors=4004,
        media_descriptor=MEDIA_DESCRIPTOR_8INCH_DD,
        root_entries=192,
        sectors_per_fat=6,
        sectors_per_cluster=4,
    ),
